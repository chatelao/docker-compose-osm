...
Vagrant.configure("2") do |config|
  ...
  config.vm.synced_folder "./osm_import",   "/vagrant_data/osm_import"
  ...
  #   git clone https://github.com/openfirmware/docker-postgres-osm .
  #   
  #   # Rohe DB mit PostGIS Erweiterung
  #   git clone https://github.com/openfirmware/docker-osm2pgsql .
  #   
  #   # Der Renderd-Server mit Apache mod_tile
  #   git clone https://github.com/mguentner/docker-renderd-osm .
  # SHELL
